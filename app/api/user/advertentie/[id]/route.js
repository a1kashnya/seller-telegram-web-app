...
export async function GET(request, { params: {id} }) {
    const publications = [ 
        ...
        { id: 3, status: 'Отклонена', action_name: 'Модные кепки', product_name: 'Кепки', market_name: 'WB', cashback: '20', team_name: '4rth', request: 'Синие купки бесплатно' },
        ...
        { id: 5, status: 'Отклонена', action_name: 'Новинки недели', product_name: 'Майки', market_name: 'OZON', cashback: '20', team_name: '4rth', request: 'Синие майки бесплатно' },
    ]
