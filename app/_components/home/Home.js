...
const Home = () => {
    return (
        <div>
            ...
            <div className="grid gap-3 border-t border-b py-5 border-slate-800 rounded-md">
                <Link className="block w-full bg-blue-500 text-blue-100 text-xs text-center rounded-2xl font-medium uppercase px-2 py-4" href="pages/publication/create">Создать объявление/акцию</Link>
                ...
                <Link className="block w-full bg-blue-500 text-blue-100 text-xs text-center rounded-2xl font-medium uppercase px-2 py-4" href="pages/balance/deposit">Пополнить баланс</Link>
                <Link className="block w-full bg-blue-500 text-blue-100 text-xs text-center rounded-2xl font-medium uppercase px-2 py-4" href="pages/publication/publish">Опубликовать объявление/акцию</Link>
            </div>
        </div>
    )
}
